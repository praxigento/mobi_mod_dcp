    ...
    extends \Praxigento\Core\Data
{
    ...
    /** @var  \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response\Body\Customer */
    public $respCustomer;
    /** @var  \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response\Body\Sections */
    public $respSections;
     ...
     */
    public function getRespCustomer(): \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response\Body\Customer
    {
        $result = $this->get(self::RESP_CUSTOMER);
        assert($result instanceof \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response\Body\Customer);
        return $result;
    }
     ...
     */
    public function getRespSections(): \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response\Body\Sections
    {
        $result = $this->get(self::RESP_SECTIONS);
        assert($result instanceof \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response\Body\Sections);
        return $result;
    }
    ...
    public function getWebRequest(): \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Request
    {
        $result = $this->get(self::WEB_REQUEST);
        return $result;
    }

    public function getWebResponse(): \Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response
    {
    ...
    public function setWebRequest(\Praxigento\Dcp\Api\Web\Dcp\Report\Check\Request $data)
    {
        $this->set(self::WEB_REQUEST, $data);
    }

    public function setWebResponse(\Praxigento\Dcp\Api\Web\Dcp\Report\Check\Response $data)
    {
